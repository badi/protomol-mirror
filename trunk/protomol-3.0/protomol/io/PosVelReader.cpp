...
namespace ProtoMol {
  ...
  PosVelReader::PosVelReader() : myFilename(""), myOk(true),
    myType(PosVelReaderType::UNDEFINED) {}

  PosVelReader::PosVelReader(const string &filename) : myFilename(filename),
    myOk(isAccessible(filename)), myType(PosVelReaderType::UNDEFINED) {}
  ...
  PosVelReader &operator>>(PosVelReader &posReader,
