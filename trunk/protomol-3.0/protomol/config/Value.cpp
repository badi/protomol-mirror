...
namespace ProtoMol {
  ...
  Value::Value(const std::string &value) :
    myValue(new Holder<ValueTraits<std::string> >(value)) {}
  Value::Value(const char *value) :
    myValue(new Holder<ValueTraits<std::string> > (value)) {}
  Value::Value(int value) : myValue(new Holder<ValueTraits<int> >(value)) {}
  Value::Value(unsigned int value) :
    myValue(new Holder<ValueTraits<unsigned int> >(value)) {}
  Value::Value(Real value) : myValue(new Holder<ValueTraits<Real> >(value)) {}
  Value::Value(bool value) : myValue(new Holder<ValueTraits<bool> >(value)) {}
  ...
  Value::Value(const Value &other) :
    myValue(other.myValue ? other.myValue->clone() : NULL) {}

  Value::Value(const std::string &value, const Undefined *) :
    myValue(new Holder<ValueTraits<std::string> >(value, false)) {}
  ...
  Value::Value(const Value &value, const Undefined *) :
    myValue(value.myValue ? value.myValue->clone() : NULL) {
    clear();
  }
  ...
  void Value::read(std::istream &is) {
  ...
  template<>
  inline bool Value::greaterEqual<vector<Real> >(const Value &, const Value &) {
    return false;
  }
