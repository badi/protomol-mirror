...
namespace ProtoMol {
  ...
  //________________________________________ FactoryTraits<GenericTopology>
  template<>
  ...
  public:
    ...
    static GenericTopology *make(std::string &errMsg,
  ...
  private:
    ...
    GenericTopology *doMake(std::string &errMsg,
                            const std::string &id,
