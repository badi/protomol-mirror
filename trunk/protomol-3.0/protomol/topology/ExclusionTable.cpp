...
namespace ProtoMol {
  ...
  ExclusionPair::ExclusionPair() : a1(-1), a2(-1), excl(EXCLUSION_NONE) {}
  ExclusionPair::ExclusionPair(int a,
                               int b) : a1(a), a2(b), excl(EXCLUSION_NONE) {}
  ExclusionPair::ExclusionPair(int a, int b,
                               ExclusionClass c) : a1(a), a2(b), excl(c) {}
  ...
  ExclusionTable::ExclusionTable() : lowDeltas(NULL), anyExclsForThisDelta(NULL),
    myMaxDelta(0), myCurrentSize(0), myFastDeltaMax(0) {}
