...
void Born<TOneAtomPair>::evaluateBorn(TOneAtomPair &myOneAtomPair,
  ...
  for (int i = 0; i < topo->atoms.size(); i++) {
    ...
    for (unsigned int k = 0;
      ...
      int j = myOneAtomPair.getNonbondedForceFunction()->getInteraction(i, k);
  ...
  for (int b = 0; b < topo->atoms.size(); b++) {
