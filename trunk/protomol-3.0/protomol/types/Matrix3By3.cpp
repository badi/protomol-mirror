...
namespace ProtoMol {
  ...
  const Matrix3By3 Matrix3By3::ourIdentity = Matrix3By3(1,
    0,
    0,
    0,
    1,
  ...
  void convert(const Matrix3By3 &from, float to[9]) {
    to[0] = static_cast<float>(from.m00); to[1] = static_cast<float>(from.m01);
    to[2] = static_cast<float>(from.m02);
    to[3] = static_cast<float>(from.m10); to[4] = static_cast<float>(from.m11);
    to[5] = static_cast<float>(from.m12);
    to[6] = static_cast<float>(from.m20); to[7] = static_cast<float>(from.m21);
    to[8] = static_cast<float>(from.m22);
  }

  void convert(const Matrix3By3 &from, double to[16]) {
    to[0] = static_cast<double>(from.m00); to[1] = static_cast<double>(from.m01);
    to[2] = static_cast<double>(from.m02);
    to[3] = static_cast<double>(from.m10); to[4] = static_cast<double>(from.m11);
    to[5] = static_cast<double>(from.m12);
    to[6] = static_cast<double>(from.m20); to[7] = static_cast<double>(from.m21);
