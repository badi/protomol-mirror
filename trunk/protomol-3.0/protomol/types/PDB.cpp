...
namespace ProtoMol {
  ...
  PDB::Atom::Atom() : elementType(""), elementNum(0), elementName(""),
    altLoc(""), residueName(""), chainID(""), residueNum(0), insertionCode(""),
    occupancy(0.0), tempFactor(0.0), segID(""), symbol(""), charge(""),
    hvyAtomGrpsize(0) {}
  ...
  PDB::Atom::Atom(std::string etype,
                  ...
                  std::string symname,
                  std::string c,
                  int ha) : elementType(etype), elementNum(anum),
    elementName(ename), altLoc(altloc), residueName(rname), chainID(chain),
    residueNum(rnum), insertionCode(insertion), occupancy(occ), tempFactor(tf),
    segID(segname), symbol(symname), charge(c), hvyAtomGrpsize(ha) {}

  PDB::Ter::Ter() : elementType(""), elementNum(0), residueName(""), chainID(""),
    residueNum(0), insertionCode("") {}
  ...
  PDB::Ter::Ter(std::string etype,
                ...
                std::string chain,
                int rnum,
                std::string insertion) : elementType(etype), elementNum(anum),
