...
namespace ProtoMol {
  ...
  public:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    virtual void evaluate(const GenericTopology *, const Vector3DBlock *,
                          Vector3DBlock *,
                          ScalarStructure *);
  ...
  template<class TCellManager, class TOneAtomPair>
  void NonbondedCutoffSystemForce<TCellManager, TOneAtomPair>::evaluate(
  ...
  template<class TCellManager, class TOneAtomPair>
  void NonbondedCutoffSystemForce<TCellManager, TOneAtomPair>::parallelEvaluate(
    const GenericTopology *topo, const Vector3DBlock *positions,
    Vector3DBlock *forces, ScalarStructure *energies) {
    const RealTopologyType *realTopo =
      dynamic_cast<const RealTopologyType *>(topo);
